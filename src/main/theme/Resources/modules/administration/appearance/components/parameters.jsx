...
import {AppearanceThemes} from '#/main/theme/administration/appearance/containers/themes'
          ...
          fields: [
            {
              ...
              options: {
                ...
                condensed: false,
                noEmpty: true,
                choices: props.availableThemes.reduce((acc, current) => Object.assign(acc, {
